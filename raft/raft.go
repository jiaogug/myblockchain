...
const (
	...
	HBINTERVAL = 50 * time.Millisecond // 50ms  心跳时间间隔
)
...
// of all the Raft servers (including this one) are in peers[]. this  所有的raft节点都在peers[]结构里，当前运行的raft节点是peers[me]
// server's port is peers[me]. all the servers' peers[] arrays
// have the same order. persister is a place for this server to
// save its persistent state, and also initially holds the most   persister 保存了节点的状态，L C F
